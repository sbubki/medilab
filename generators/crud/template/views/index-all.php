...
$this->title = <?= $generator->generateString("Archive for {$modelNamePlural}") ?>;
<?php if ($moduleId !== 'app'): ?>
...
<?php endif; ?>
$this->params['breadcrumbs'][] = Yii::t('cruds', "Archive");
?>

<div class="app-crud <?= $modelSlug ?>-index-all">
    ...
    <div class="clearfix crud-navigation" style="padding-top: 30px;">
        ...
        <div class="pull-right">
            <div>
                ...
                echo Html::a($label, ['index-deleted'], $options);
                ?>
